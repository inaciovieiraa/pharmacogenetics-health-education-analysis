...
* [**`/data`**](./data): Base de dados anonimizada em `.csv` (Baseline coletado em 07/05/2026).
* [**`/scripts`**](./scripts): Código em R ([`script_pre_intervencao.R`](./scripts/script_pre_intervencao.R)) com o pipeline de ETL e geração de gráficos.
* [**`/plots`**](./plots): Gráficos exportados em alta resolução (.png) analisando os mitos do senso comum na enfermagem.
---
